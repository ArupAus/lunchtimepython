...
3. You'll be asked to enter a few details about yourself, and pick a username. Enter in your details and continue on to the next step.
...
5. Into the search box type `python` and click on the channel `# python`.
